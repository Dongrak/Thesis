...
P_result_exact=rbind(p_aft,p_cox);P_result_exact
P_result_0.05_0.095=rbind((p_aft>=0.95)*1,(p_cox<=0.05)*1);P_result_0.05_0.095
P_result_binary=rbind((p_aft==1)*1,(p_cox==0)*1);P_result_binary
...
#-----------------------AFT DATA ANALYSIS---------------------
#-------------------------------------------------------------
What_t=function(b=beta_hat_aft,Time=T_aft,Delta=D_aft,Covari=Z_aft,tol=given_tol,weight=given_weight,test=given_test){
  #b=beta_hat_aft;weight=given_weight;Time=T_aft;Delta=D_aft;Covari=Z_aft;tol=given_tol;

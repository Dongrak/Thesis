...
simulation_link=function(simulation,n,path,alpha,tol){
  ...
  for (k in 1:simulation) {
    ...
    # result_ln_aft_f
    result_ln_aft_f=afttest_link(path,beta_hat_ln_aft_f,std_hat_ln_aft_f,

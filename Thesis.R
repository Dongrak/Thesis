...
# -----------------------COX DATA ANALYSIS---------------------
# -------------------------------------------------------------
W_t=function(b=beta_hat_cox,Time=T_cox,Delta=D_cox,Covari=Z_cox,weight=given_weight){
...
# -----------------------AFT DATA ANALYSIS---------------------
# -------------------------------------------------------------
What_t=function(b=beta_hat_aft,Time=T_aft,Delta=D_aft,Covari=Z_aft,weight=given_weight,tol=given_tol){
...
system.time(
  for(k in 1:iteration){
    ...
    P_result_0.05_0.095=rbind((p_aft>=0.9)*1,(p_cox<=0.1)*1)
    ...
    result_p[[k]]=list(P_result_exact,P_result_0.05_0.095,P_result_binary)
    
    result[[k]]=list(result_aft.aft[[k]],result_cox.cox[[k]],result_p[[k]])
  }
)
result_n_exact=0
result_n_binary=0
result_n_0.05_0.095=0

for(k in 1:iteration){
  result_n_exact=result_n_exact+result_p[[k]][[1]]
  result_n_0.05_0.095=result_n_0.05_0.095+result_p[[k]][[2]]
  result_n_binary=result_n_binary+result_p[[k]][[3]]
}

P_result_exact=result_n_exact/iteration;P_result_exact
P_result_0.05_0.095=result_n_0.05_0.095/iteration;P_result_0.05_0.095
